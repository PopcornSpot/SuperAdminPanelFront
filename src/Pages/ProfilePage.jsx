...
const SuperAdminProfilePage = () => {
  const superAdmin = {
    ...
    contact: "1234567890",
    role: "Super Admin",
    permissions: ["Manage Users", "Access Reports", "System Settings", "Monitor Activity"],
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow rounded-lg p-4 text-center">
            ...
            <p className="text-2xl font-bold text-gray-800">{superAdmin.stats.reportsGenerated}</p>
          </div>
        </div>
      </div>
